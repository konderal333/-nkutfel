...
A \ref{fig:2019minmax3}. ábrán láthatóak a matematika-nyelvi teszt és a felvételi pontszám részeiről készített szórásdiagramok a 2019-es adatokon. Ebben az esetben volt két hallgató, aki pont duplázással számította a teljes felvételi pontszámát, így a hozott pontszámánál 0 állt értékként. Ez természetesen torzítást okozott a megfelelő részábrákon, így ki lettek véve. A változók itt min-max skálázva vannak, így minden tengelyen 0-tól 1-ig vannak értékek.
...
\bibitem{magyar2} Ágnes Proháczik. A tantermi és az on-line oktatás (tanítás és tanulás) összehasonlító elemzése. \textit{Opus et Educatio}, Volume7. No.3, 2020. \url{http://opuseteducatio.hu/index.php/opusHU/article/view/390/672}
...
\bibitem{dbscan}M. Ester, H. P. Kriegel, J. Sander, X. Xu. A Density-Based Algorithm for Discovering Clusters in Large Spatial Databases with Noise. \textit{In Proceedings of the 2nd International Conference on Knowledge Discovery and Data Mining}, AAAI Press, pages 226–231, 1996.
