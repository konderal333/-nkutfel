...
Az adatokat Szilágyi Brigitta tanárnő bocsátotta rendelkezésünkre. A kutatáshoz összesen 4 fajta bemeneti adatot vizsgáltunk: felvételi pontszám (3 részre bontva: tanulmányi pont, érettségi pont és többletpont), a 0. ZH-n elért pontszám, a kognitív teszten elért teljesítmény valamint bináris változók arra vonatkozóan, hogy emelt érettségit tett-e a hallgató illetve matematika tagozatos volt-e. Ezen adatok különböző adattáblákban voltak tárolva .
