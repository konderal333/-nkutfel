...
Az alapvető egyesítő módszerek a single, average, complete linkage nevet hordozzák, de mi a Ward féle linkage módszert alkalmaztuk. Ez a módszer az összes klaszteren belüli szórásnégyzet minimalizálására törekszik, így valamelyest hasonlít a k-özép algoritmusra. A többi módszerrel szemben az az előnye, hogy nem jönnek létre nagyon eltérő méretű csoportok.
...
A k-közép algoritmus eredményei közül kettőt emelhetünk ki. Az egyikben a 2019-es adatokból négy változó szerepelt, min-max skálázva: egyesített teszteredmény, első féléves átlag, kumulált átlag és a felvételi összpontszám. Ennek a változatnak a könyökszabály ábrája tekinthető meg alább:
