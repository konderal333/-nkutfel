...
\subsection{Adattáblák jellemzése, adattisztítás}

Az adatokat az EduBase és Neptun rendszerből lekérve több adattábla Neptun-kód alapú összeillesztésével nyertük. A kutatáshoz használt adatok mind olyanok, amelyek, illetve teljesítménymutatók, amelyekről csak a félév végén lesz információnk (utóbbiak prediktálására építünk modelleket a prediktív analitikai részben). A változók pontos megnevezése és adatstruktúrája:
\begin{table}
\centering
\begin{tabular}{|c|c|}
\hline
...
\hline
Matematika 1. blokk & \makecell{Diszkrét változó, az elsőéves VBK hallgatók által írt kognitív teszt\\ matematika részének 1-4. kérdésekre adott helyes válaszok száma.} \\
\hline
Matematika 2. blokk & \makecell{Diszkrét változó, a kognitív teszt \\5-10. kérdésekre adott helyes válaszok száma.} \\
\hline
Matematika 3. blokk & \makecell{Diszkrét változó, a kognitív teszt \\11-14. kérdésekre adott helyes válaszok száma.} \\
\hline
Matematika eredmény & \makecell{Folytonos változó, a kognitív teszt matematika részén\\ elért százalékos teljesítmény (0-100-as skálán).} \\
\hline
Kognitív eredmény & \makecell{Folytonos változó, a kognitív teszt kognitív készségeket mérő részén\\ elért százalékos teljesítmény (0-100-as skálán).}\\
\hline
0. ZH pontszám & Diszkrét változó, a BME központi 0. ZH-n elért pontszám. \\
\hline
Tanulmányi pont & Diszkrét változó, a felvételi pontszám tanulmányi pontokból származó része \\
\hline
Érettségi pont & Diszkrét változó, a felvételi pontszám érettségi pontokból származó része \\
\hline
Többletpont & Diszkrét változó, a felvételi pontszám többletpontokból származó része \\
\hline
Matematika A1a
...
A táblák összetűzése Neptun-kód alapján történt belső illesztés alkalmazásával. Azonban voltak olyan hallgatók, akikről nem minden táblában volt adat (vagy azért, mert nem írtak kognitív tesztet, vagy azért, mert az első félév vége előtt elhagyták a szakot), így az összeillesztés során 10-20 fős sorvesztéssel kellett számolnunk mindkét évben. Az így kapott adattáblák, amelyek a 2019-es és 2021-es évet reprezentálják, rendre 200 és 220 adatrekordot tartalmaztak, valamint mindkét tábla 16 attribútumaml rendelkezett, amelyek rendre a ['Neptun'], ['Hallgató neve'], ['Matematika tagozat'], ['Emelt érettségi'] ['Szak'], ['Matematika 1. blokk'], ['Matematika 2. blokk'], ['Matematika 3. blokk'], ['Matematika eredmény'], ['Kognitív eredmény'], ['0. ZH pontszám'], ['Tanulmányi pont'] ['Érettségi pont'], ['Többletpont'], ['Matematika A1a jegy'] ,['Kumulált átlag'].
